...
Revision ID: db68b42fcf42
Revises: 
Create Date: 2023-03-21 14:52:13.426046
...
def upgrade():
    ...
    sa.Column('fullname', sa.String(length=80), server_default='', nullable=False),
